...
def send_mail():
    ...
    configuration.api_key['api-key'] = 'xsmtpsib-7c0390d2b86d88aebfc75d1d2bd82f10c77b3bce9e2dce60b87c3913f12737fa-7krpgbhnXY6tS2KP'
    ...
    # Definir o e-mail 
    # sendTo = sib_api_v3_sdk.SendSmtpEmailTo(email='2009764@aluno.univesp.br', name='Projeto integrador - ')
    
    # Quem recebe
    sendTo = sib_api_v3_sdk.SendSmtpEmailTo(email="2009764@aluno.univesp.br", name=f'Contato - {user_nome} - {user_phone}')
